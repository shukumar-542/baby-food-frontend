    ...
    return (
        <div className="grid grid-cols-2 gap-10  justify-center items-center">
            ...
            <div className="space-y-2">
                ...
                <p>Thank you for visiting baby shop Farm! We’d love to hear from you and answer any questions you may have. Please fill in the details below, hit send, and a member of our team will be in touch with you shortly.</p>
            </div>
        </div>
    );
};
